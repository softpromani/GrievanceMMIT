	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6 order-2 order-md-1 text-center text-md-left">
				<h1 class="text-white font-weight-bold mb-4">UPASHSA</h1>
				<p class="text-white mb-5">Est -1989</p>
				<a href="#" class="btn btn-main-md">Register Now</a>
			</div>
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="{{ asset('home/images/mobile.png') }}" alt="screenshot">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="{{ asset('home/images/feature/feature-new-01.jpg') }}" alt="iphone">
				</div>
			</div>
				...
				<div class="testimonial">
					...
					<ul class="list-inline meta">
						<li class="list-inline-item">
							<img src="{{ asset('home/images/testimonial/feature-testimonial-thumb.jpg') }}" alt="">
						</li>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="{{ asset('home/images/feature/feature-new-02.jpg') }}" alt="ipad">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-6 align-self-center">
				...
				<div class="service-thumb left" data-aos="fade-right">
					<img class="img-fluid" src="{{ asset('home/images/feature/iphone-ipad.jpg') }}" alt="iphone-ipad">
				</div>
			</div>
				...
				<div class="testimonial-slider owl-carousel owl-theme">
					...
					<div class="item">
						<div class="block shadow">
							...
							<!-- Person Thumb -->
							<div class="image">
								<img src="{{ asset('home/images/testimonial/feature-testimonial-thumb.jpg') }}" alt="image">
							</div>
							<!-- Name and Company -->
